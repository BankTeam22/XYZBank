...
public class Check {
    ...
    // Method to perform AssertNot Equals
    public static void checkNotEquals(String v1, String v2, String msg) {
        Assert.assertNotEquals(v1, v2, msg);
    }
    ...
    public static void checkTrue(String msg, boolean b1) {
